...
import com.example.deliciousfood.data.remote.api.DelFoodApi.Companion.BASE_URL
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideBaBrApi(retrofit: Retrofit.Builder): DelFoodApi =
        retrofit.baseUrl(BASE_URL).build().create(DelFoodApi::class.java)
}
